...
function generateTodoList(){
    todoListArray.forEach((element,i) => {
        if (!document.getElementById(`list${i}`)){
            ...
            (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.appendChildren)(list,[listHead,listBody]);
