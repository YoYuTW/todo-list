...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n    margin: 0;    \n}\n\nheader{\n    box-sizing: border-box;\n    margin: 0;\n    height: 3vh;\n    color: white;\n    background-color: #305e08;\n    \n}\n\nmain{\n    display: flex;\n    height: 95vh;\n}\n\n#sidebar{\n    box-sizing: border-box;\n    width: 15%;\n    margin: 0;  \n}\n\n#content{\n    width: 85%;\n    padding: 10px;\n    background-color: #8fa878;    \n}\n\n#toolBar{    \n    display: flex;\n    margin-bottom: 10px;\n    height: 5%;\n    align-items: center;\n}\n\n.functionalBtn {\n    width: fit-content;  \n    height: fit-content;  \n    border: 2px black solid;\n    border-radius: 5px;\n    padding: 5px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n#todoBox {    \n    display: flex; \n    height: 95%;\n    gap: 1vw;        \n    overflow-x: auto;\n    -ms-overflow-style: -ms-autohiding-scrollbar; \n}\n\n.todoList {\n    display: flex;\n    flex-flow: column;   \n    justify-content: flex-start;\n    align-items: center;\n    background-color: grey;\n    width: 450px;\n    gap: 1%\n}\n\n.head {\n    box-sizing: border-box;\n    width: 100%;    \n    height: 5%;\n    padding: 3%;\n    display: flex;    \n    align-items: center;\n}\n\n.name{    \n    font-size: 270%;\n    flex: 7;\n    min-height: 30px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.addTodoBtn {\n    display: flex;\n    flex-flow: nowrap;\n    flex: 3;\n    font-size: 80%;\n}\n\n.body {\n    height: 90%;\n    width: 100%;\n    display: flex;\n    flex-flow: column;\n    justify-content: flex-start;\n    align-items: center;\n    gap: 2%;\n}\n\n.todo {\n    box-sizing: border-box;\n    width: 90%;\n    height: 10%;\n    border-radius: 10px;\n    background-color: white;  \n    display: flex;\n    flex-flow: column;    \n}\n\n.top {\n    margin: 1% 5% 0 5%;\n    display: flex;\n    height: 20%;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.title {\n    width: 30%;\n}\n\n.description {\n    margin: 0 5%;\n    height: 50%;\n}\n\n.foot {\n    height: 28%;\n    margin: 0 5% 1% 5%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\n.deleteBtn {\n    font-size: 3%;\n}\n\n.hasDone {\n    background-color: black;\n}\n\nfooter {\n    background-color: #1d3805;\n    height: 2vh;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;AACb;;AAEA;IACI,sBAAsB;IACtB,SAAS;IACT,WAAW;IACX,YAAY;IACZ,yBAAyB;;AAE7B;;AAEA;IACI,aAAa;IACb,YAAY;AAChB;;AAEA;IACI,sBAAsB;IACtB,UAAU;IACV,SAAS;AACb;;AAEA;IACI,UAAU;IACV,aAAa;IACb,yBAAyB;AAC7B;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,UAAU;IACV,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,mBAAmB;IACnB,uBAAuB;IACvB,kBAAkB;IAClB,YAAY;IACZ,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,WAAW;IACX,QAAQ;IACR,gBAAgB;IAChB,4CAA4C;AAChD;;AAEA;IACI,aAAa;IACb,iBAAiB;IACjB,2BAA2B;IAC3B,mBAAmB;IACnB,sBAAsB;IACtB,YAAY;IACZ;AACJ;;AAEA;IACI,sBAAsB;IACtB,WAAW;IACX,UAAU;IACV,WAAW;IACX,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,OAAO;IACP,gBAAgB;IAChB,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,iBAAiB;IACjB,OAAO;IACP,cAAc;AAClB;;AAEA;IACI,WAAW;IACX,WAAW;IACX,aAAa;IACb,iBAAiB;IACjB,2BAA2B;IAC3B,mBAAmB;IACnB,OAAO;AACX;;AAEA;IACI,sBAAsB;IACtB,UAAU;IACV,WAAW;IACX,mBAAmB;IACnB,uBAAuB;IACvB,aAAa;IACb,iBAAiB;AACrB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,WAAW;IACX,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,WAAW;IACX,kBAAkB;IAClB,aAAa;IACb,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,yBAAyB;IACzB,WAAW;AACf","sourcesContent":["body {\n    margin: 0;    \n}\n\nheader{\n    box-sizing: border-box;\n    margin: 0;\n    height: 3vh;\n    color: white;\n    background-color: #305e08;\n    \n}\n\nmain{\n    display: flex;\n    height: 95vh;\n}\n\n#sidebar{\n    box-sizing: border-box;\n    width: 15%;\n    margin: 0;  \n}\n\n#content{\n    width: 85%;\n    padding: 10px;\n    background-color: #8fa878;    \n}\n\n#toolBar{    \n    display: flex;\n    margin-bottom: 10px;\n    height: 5%;\n    align-items: center;\n}\n\n.functionalBtn {\n    width: fit-content;  \n    height: fit-content;  \n    border: 2px black solid;\n    border-radius: 5px;\n    padding: 5px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n#todoBox {    \n    display: flex; \n    height: 95%;\n    gap: 1vw;        \n    overflow-x: auto;\n    -ms-overflow-style: -ms-autohiding-scrollbar; \n}\n\n.todoList {\n    display: flex;\n    flex-flow: column;   \n    justify-content: flex-start;\n    align-items: center;\n    background-color: grey;\n    width: 450px;\n    gap: 1%\n}\n\n.head {\n    box-sizing: border-box;\n    width: 100%;    \n    height: 5%;\n    padding: 3%;\n    display: flex;    \n    align-items: center;\n}\n\n.name{    \n    font-size: 270%;\n    flex: 7;\n    min-height: 30px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.addTodoBtn {\n    display: flex;\n    flex-flow: nowrap;\n    flex: 3;\n    font-size: 80%;\n}\n\n.body {\n    height: 90%;\n    width: 100%;\n    display: flex;\n    flex-flow: column;\n    justify-content: flex-start;\n    align-items: center;\n    gap: 2%;\n}\n\n.todo {\n    box-sizing: border-box;\n    width: 90%;\n    height: 10%;\n    border-radius: 10px;\n    background-color: white;  \n    display: flex;\n    flex-flow: column;    \n}\n\n.top {\n    margin: 1% 5% 0 5%;\n    display: flex;\n    height: 20%;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.title {\n    width: 30%;\n}\n\n.description {\n    margin: 0 5%;\n    height: 50%;\n}\n\n.foot {\n    height: 28%;\n    margin: 0 5% 1% 5%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\n.deleteBtn {\n    font-size: 3%;\n}\n\n.hasDone {\n    background-color: black;\n}\n\nfooter {\n    background-color: #1d3805;\n    height: 2vh;\n}"],"sourceRoot":""}]);
// Exports
...
function addTodoList(){    
    const TodoList = () => {
        const title = window.prompt('請輸入列表名稱','新增列表');
        const todo = [];
        return {title,todo}
    }
...
function generateTodoList(){
    todoListArray.forEach((element,i) => {
        if (!document.getElementById(`list${i}`)){
            const list = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['todoList',`list${i}`]);        
            list.id = `list${i}`;          

            const listHead = (() => {
                const head = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['head',`list${i}`]);

                const title = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['name',`list${i}`]);
                title.innerHTML = element.title;
                title.addEventListener('click',_changeName)

                const addTodoBtn = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['functionalBtn','addTodoBtn',`list${i}`]);
                addTodoBtn.innerHTML = '＋新建待辦事項';
                addTodoBtn.addEventListener('click',_addTodo__WEBPACK_IMPORTED_MODULE_1__.addTodo);
                
                (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.appendChildren)(head,[title,addTodoBtn]);
                return head
            })();

            const listBody = (() => {
                const body = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['body',`list${i}`]);                              
                return body
            })();

            const delBtn = (() => {
                const delBtn = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['functionalBtn',`list${i}`]);
                delBtn.innerHTML = '刪除待辦列表';
                delBtn.addEventListener('click',_deleteTodolist);
                return delBtn
            })();
            
            (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.appendChildren)(list,[listHead,listBody,delBtn]);

            document.getElementById('todoBox').appendChild(list);
            (0,_addTodo__WEBPACK_IMPORTED_MODULE_1__.generateTodo)(element,list);  
        }
    });
}
...
function _deleteTodolist(e) {
    const classList = Array.from(e.target.classList);  
    const listID = classList[1];
    const todoList = document.getElementById(listID);
    if (window.confirm(`確定要刪除：${todoList.firstChild.firstChild.innerHTML}？`)) {
        todoList.remove();
        todoListArray.splice(listID.slice(4),1);
        localStorage.setItem('todoList',JSON.stringify(todoListArray));  
    }
}
...
function generateTodo(todoListData,todoListWeb){
    todoListData.todo.forEach((v,i) => {
        if (!document.getElementById(`${todoListWeb.id}-${i}`)){
            const todo = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['todo',`list${i}`]);
            todo.id = `${todoListWeb.id}-todo${i}`;
            (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.appendChildren)(todo,_createTodoDiv(v,i,todoListWeb.id));
...
function _createTodoDiv(v,i,listID) {
    ...
    ['title','dueDate','priority','description','note'].map(x=>{
        const block = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)([x,`todo${i}`,listID]);
        block.innerHTML = v[x];
        block.addEventListener('click',_changeContent);    
        return block        
    }) 
    const top = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['top',`todo${i}`,listID]);    
    const checkbox = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['checkbox','functionalBtn',`todo${i}`,listID]);
    checkbox.innerHTML = '';
    v.checklist ? checkbox.classList.add('hasDone') : null;
    checkbox.addEventListener('click',_hasDoneOrNot);
    (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.appendChildren)(top,[title,dueDate,priority,checkbox]);

    const foot = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['foot',`todo${i}`,listID]);
    const deleteBtn = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.NewElementForClass)(['deleteBtn','functionalBtn',`todo${i}`,listID]);
    deleteBtn.innerHTML = '刪除待辦事項'
    deleteBtn.addEventListener('click',_deleteTodo);
    (0,_createNewElement__WEBPACK_IMPORTED_MODULE_0__.appendChildren)(foot,[note,deleteBtn]);
...
/* harmony export */   "NewElementForClass": () => (/* binding */ NewElementForClass)
/* harmony export */ });
...
/* harmony import */ var _createNewElement__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createNewElement */ "./src/createNewElement.js");
...
function component(){
    ...
    header.innerHTML = `今日日期：${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date,'yyyy-MM-dd')}`;
    const main = (() => {
        const main = document.createElement('main');
        const sidebar = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_2__.NewElement)('sidebar');
        const content = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_2__.NewElement)('content');    
    
        const toolBar = (() => {
            const toolBar = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_2__.NewElement)('toolBar');
            const addTodoListBtn = document.createElement('div');
            addTodoListBtn.innerHTML = "＋新建列表";
            addTodoListBtn.classList.add('functionalBtn');
            addTodoListBtn.addEventListener('click',_addList__WEBPACK_IMPORTED_MODULE_0__.addTodoList);
            toolBar.appendChild(addTodoListBtn);
            return toolBar;
        })();       

        const todoBox = (0,_createNewElement__WEBPACK_IMPORTED_MODULE_2__.NewElement)('todoBox');    

        (0,_createNewElement__WEBPACK_IMPORTED_MODULE_2__.appendChildren)(content,[toolBar,todoBox]);
        (0,_createNewElement__WEBPACK_IMPORTED_MODULE_2__.appendChildren)(main,[sidebar,content]);
